describe 'Day 04' do
  ...
  EXAMPLE_INPUT_DAY_04 = <<~INPUT.chomp.split("\n")
  ...
  describe Bingo do
    let(:bingo) { Bingo.new(EXAMPLE_INPUT_DAY_04) }
    ...
    describe '#boards_won' do
      ...
      it 'return the won boards correctly in another test case' do
        test_case = EXAMPLE_INPUT_DAY_04.clone
  ...
  describe 'Part A acceptance test' do
    it 'solve the example case correctly' do
      bingo = Bingo.new(EXAMPLE_INPUT_DAY_04)
